...
const inputClassNames: SlotsToClasses<InputSlots> = {
  inputWrapper: "flip_item h-[2.625rem] rounded-lg bg-l1 border-none backdrop-blur-lg shadow-1 text-xs",
  label: "text-xs",
  ...
  return (
    <VerificationInput
      ...
      classNames={{
        ...
        character: "rounded-lg max-w-[2.625rem]  w-[2.625rem] bg-l1 bg-transparent backdrop-blur-[20px] text-white text-xl leading-[2.625rem] uppercase",
      }}
    />
  );
}
