...
const Types = [{ type: "shoes", count: 4 }, { type: "pants", count: 4 }, { type: 'leftHand', count: 4 }, { type: 'rightHand', count: 4 }, { type: "clothes", count: 5 }, { type: "logo", count: 6 }, { type: "face", count: 4 }, { type: "head", count: 4 }, { type: "hat", count: 5 }] as const
const getSvgPath = (
          ...
          <foreignObject x="0" y="0" width="200" height="450">
            <div className="relative m-auto flex items-center justify-center">
              ...
              <img
                ...
                alt="clothes"
                crossOrigin="anonymous"
                style={{ position: "absolute", left: 15, top: "235px", zIndex: 2 }}
              />
              <img
              ...
              <img
                ...
                alt="head"
                crossOrigin="anonymous"
                style={{ position: "absolute", left: 0, top: "48px", width: "220px", zIndex: 4 }}
              />
              <img
