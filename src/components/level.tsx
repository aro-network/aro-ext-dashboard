...
export const levels = [
  { icon: Level0, exp: 0, level: 0, name: "Baby Berry", boost: "+ 0%", boostNum: 1, color: "#DFDFDF" },
  { icon: Level1, exp: 100, level: 1, name: "Teen Berry", boost: "+ 50%", boostNum: 1.5, color: "#EAE0F0" },
  { icon: Level2, exp: 500, level: 2, name: "Big Blue", boost: "+ 100%", boostNum: 2, color: "#8A9CF1" },
  { icon: Level3, exp: 1000, level: 3, name: "Berry Captain", boost: "+ 200%", boostNum: 3, color: "#FFFBB4" },
];
