...
export const levels = [
  { icon: Level0, exp: 0, name: "Berry Baby", boost: "+ 0%", color: "#DFDFDF" },
  { icon: Level1, exp: 100, name: "Blue Berry", boost: "+ 50%", color: "#EAE0F0" },
  { icon: Level2, exp: 500, name: "Sliver Berry", boost: "+ 100%", color: "#8A9CF1" },
  { icon: Level3, exp: 1000, name: "Gold Berry", boost: "+ 200%", color: "#FFFBB4" },
];
